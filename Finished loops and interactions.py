...
## FOR LOOPS: allows iteration through a list/object
...
#loops in side new work area, it won't be visible unless you make it visible with print command
for v in list1:
    print(v)
...
list6 = [v**2 < 144 for v in list1] #this fails because cannot square a string

##iterating using enumeration
list7 = [ [i,v/2] for i, v in enumerate(list1)]
#returns index (i) and v/2 for each i and v in list1
